...
const RULES: { label: string; words: string[] }[] = [
  { label: 'маркетинг', words: ['лендинг', 'валидац', 'лид', 'реклам', 'сайт'] },
  { label: 'платежи', words: ['оплат', 'stripe', 'платёж', 'платеж', 'биллинг', 'подписк'] },
  { label: 'онбординг', words: ['онбординг', 'юзер', 'пользовател', 'регистрац'] },
